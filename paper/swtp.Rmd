...
# A list in which to store all tables for writing to Excel
main_tables <- list()
supplemental_tables <- list()
add_table <- function(x, name, supplemental = FALSE){
  new_tab <- list(x)
  names(new_tab) = name
  
  if(supplemental)
    supplemental_tables <<- c(supplemental_tables, new_tab)
  else
    main_tables <<- c(main_tables, new_tab)
...
readr::read_csv("./tables/variables.csv") %>%
  add_table("SWTP Variables", supplemental = FALSE) %>%
...
integration_xlsx <- "./data/raw_data/tdar-integration-SWTP.xlsx"
...
integration.data %<>%
  ...
  dplyr::arrange(Dataset,
                 ...
                 Element,
                 Portion) %>%
  add_table("Integrated Data", supplemental = TRUE)
...
data_overview <- integration.data %>%
  ...
  add_table("Data Overview", supplemental = FALSE)
...
data_inclusion <- integration.data %>%
  ...
  dplyr::ungroup() %>%
  dplyr::select(-NISP) %>%
  add_table("Data Inclusion", supplemental = FALSE)# %>%
...
data_inclusion_count %<>% 
  ...
  add_table("Data Inclusion Count", supplemental = TRUE)# %>%
  # DT::datatable(style = "bootstrap",
...
out <- "Artiodactyla" %>%
  burning() %>%
  add_table("Artiodactyla Burning", supplemental = TRUE)
...
```{r art-burning-plot, fig.cap=paste0('Artiodactyl burning. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Artiodactyla Burning"), '.')}
plot_summary(out)
```
...
out <- "Lagomorpha" %>%
  burning() %>%
  add_table("Lagomorpha Burning", supplemental = TRUE)
...
```{r lag-burning-plot, fig.cap=paste0('Lagomorph burning. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Lagomorpha Burning"), '.')}
plot_summary(out)
```
...
out <- "Meleagris gallopavo" %>%
  burning() %>%
  add_table("Meleagris Burning", supplemental = TRUE)
...
```{r meg-burning-plot, fig.cap=paste0('*Meleagris gallopavo* burning. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Meleagris Burning"), '.')}
plot_summary(out)
```
...
out <- "Artiodactyla" %>%
  butchering() %>%
  add_table("Artiodactyla Butchering", supplemental = TRUE)
...
```{r art-butchering-plot, fig.cap=paste0('Artiodactyl butchering. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Artiodactyla Butchering"), '.')}
plot_summary(out)
```
...
out <- "Lagomorpha" %>%
  butchering() %>%
  add_table("Lagomorpha Butchering", supplemental = TRUE)
...
```{r lag-butchering-plot, fig.cap=paste0('Lagomorph butchering. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Lagomorpha Butchering"), '.')}
plot_summary(out)
```
...
out <- "Meleagris gallopavo" %>%
  butchering() %>%
  add_table("Meleagris Butchering", supplemental = TRUE)
...
```{r meg-butchering-plot, fig.cap=paste0('*Meleagris gallopavo* butchering. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Meleagris Butchering"), '.')}
plot_summary(out)
```
...
out <- "Artiodactyla" %>%
  gnawing() %>%
  add_table("Artiodactyla Gnawing", supplemental = TRUE)
...
```{r art-gnawing-plot, fig.cap=paste0('Artiodactyl gnawing. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Artiodactyla Gnawing"), '.')}
plot_summary(out)
```
...
out <- "Lagomorpha" %>%
  gnawing() %>%
  add_table("Lagomorpha Gnawing", supplemental = TRUE)
...
```{r lag-gnawing-plot, fig.cap=paste0('Lagomorph gnawing. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Lagomorpha Gnawing"), '.')}
plot_summary(out)
```
...
out <- "Meleagris gallopavo" %>%
  gnawing() %>%
  add_table("Meleagris Gnawing", supplemental = TRUE)
...
```{r meg-gnawing-plot, fig.cap=paste0('*Meleagris gallopavo* gnawing. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Meleagris Gnawing"), '.')}
plot_summary(out)
```
...
out <- "Artiodactyla" %>%
  weathering() %>%
  add_table("Artiodactyla Weathering", supplemental = TRUE)
...
```{r art-weathering-plot, fig.cap=paste0('Artiodactyl weathering. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Artiodactyla Weathering"), '.')}
plot_summary(out)
```
...
out <- "Lagomorpha" %>%
  weathering() %>%
  add_table("Lagomorpha Weathering", supplemental = TRUE)
...
```{r lag-weathering-plot, fig.cap=paste0('Lagomorph weathering. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Lagomorpha Weathering"), '.')}
plot_summary(out)
```
...
out <- "Meleagris gallopavo" %>%
  weathering() %>%
  add_table("Meleagris Weathering", supplemental = TRUE)
...
```{r meg-weathering-plot, fig.cap=paste0('*Meleagris gallopavo* weathering. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Meleagris Weathering"), '.')}
plot_summary(out)
```
...
out <- "Artiodactyla" %>%
  fragmentation() %>%
  add_table("Artiodactyla Fragmentation", supplemental = TRUE)
...
```{r art-fragmentation-plot, fig.cap=paste0('Artiodactyl fragmentation. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Artiodactyla Fragmentation"), '.')}
plot_summary(out)
```
...
out <- "Lagomorpha" %>%
  fragmentation() %>%
  add_table("Lagomorpha Fragmentation", supplemental = TRUE)
...
```{r lag-fragmentation-plot, fig.cap=paste0('Lagomorph fragmentation. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Lagomorpha Fragmentation"), '.')}
plot_summary(out)
```
...
out <- "Meleagris gallopavo" %>%
  fragmentation() %>%
  add_table("Meleagris Fragmentation", supplemental = TRUE)
...
```{r meg-fragmentation-plot, fig.cap=paste0('*Meleagris gallopavo* fragmentation. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Meleagris Fragmentation"), '.')}
plot_summary(out)
```
...
out <- "Artiodactyla" %>%
  bone_weight() %>%
  add_table("Artiodactyla Bone Weight", supplemental = TRUE)
...
```{r art-bone-weight-plot, fig.cap=paste0('Artiodactyl bone weight. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Artiodactyla Bone Weight"), '.')}
...
out <- "Lagomorpha" %>%
  bone_weight() %>%
  add_table("Lagomorpha Bone Weight", supplemental = TRUE)
...
```{r lag-bone-weight-plot, fig.cap=paste0('Lagomorph bone weight. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Lagomorpha Bone Weight"), '.')}
bone_weight_plot(out)
```
...
out <- "Meleagris gallopavo" %>%
  bone_weight() %>%
  add_table("Meleagris Bone Weight", supplemental = TRUE)
...
```{r meg-bone-weight-plot, fig.cap=paste0('*Meleagris gallopavo* bone weight. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Meleagris Bone Weight"), '.')}
bone_weight_plot(out)
```
...
art_astragals <- integration.data %>%
  ...
  add_table("Artiodactyla Astragals", supplemental = TRUE)
...
```{r art-astragals-plot, fig.cap=paste0('Artiodactyl astragals. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Artiodactyla Astragals"), '.')}
...
art_phalanxes <- integration.data %>%
  ...
  affected_summary(`<25%`) %>%
  apply_element_thresholds() %>%
  add_table("Artiodactyla Phalanxes", supplemental = TRUE)
...
```{r art-phalanxes-plot, fig.cap=paste0('Artiodactyl phalanxes. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Artiodactyla Phalanxes"), '.')}
...
art_survivorship <- art_elements %>%
  ...
  add_table("Artiodactyla Surv.", supplemental = TRUE)
...
```{r art-survivorship-plot, fig.cap=paste0('Artiodactyl bone survivorship. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Artiodactyla Surv."), '.')}
...
tax_burning <- integration.data %>%
  ...
  tax_affected_summary(Burned,
                       `Probably Burned`) %>%
  apply_thresholds() %>%
  add_table("Intertax. Burning", supplemental = TRUE)
...
```{r tax-burning-plot, fig.cap=paste0('Intertaxonomic burning. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Intertax. Burning"), '.')}
...
tax_butchering <- integration.data %>%
  ...
  tax_affected_summary(Butchered,
                       `Probably Butchered`) %>%
  apply_thresholds() %>%
  add_table("Intertax. Butchering", supplemental = TRUE)
...
```{r tax-butchering-plot, fig.cap=paste0('Intertaxonomic butchering. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Intertax. Butchering"), '.')}
...
tax_complete <- integration.data %>%
  ...
  apply_thresholds() %>%
  add_table("Intertax. Fragmentation", supplemental = TRUE)
...
```{r tax-complete-plot, fig.cap=paste0('Intertaxonomic fragmentation. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Intertax. Fragmentation"), '.')}
...
out <- 
  ...
  add_table("Intertax. Survivorship", supplemental = TRUE)# %>%
  # tabler()

```

```{r tax-survivorship-plot, fig.cap=paste0('Intertaxonomic bone survivorship. Data provided in Supplemental Table ', which(names(supplemental_tables) == "Intertax. Survivorship"), '.')}
(out %>%
...
readr::read_csv("./tables/outliers.csv")  %>%
  add_table("SWTP Outliers", supplemental = FALSE) %>%
  knitr::kable(caption = "Sites identified as outliers in the SWTP analyses. Bolded assemblages are the primary outliers.") %>%
  kableExtra::kable_styling(bootstrap_options = c("striped", "hover"),
                            full_width = F)
```
...
```{r write-tables, echo = FALSE, warning = FALSE, message = FALSE, error = FALSE, collapse=TRUE, cache=FALSE, results = 'hide'}

main_tables %<>%
  magrittr::set_names(paste0(1:length(main_tables),". ",names(main_tables)))

supplemental_tables  %<>%
  magrittr::set_names(paste0("S",1:length(supplemental_tables),". ",names(supplemental_tables)))

c(main_tables, supplemental_tables) %>%
  writexl::write_xlsx("./tables/SWTP_Tables.xlsx")

file.copy("data/raw_data/tdar-integration-SWTP.xlsx", 
          "../docs/tdar-integration-SWTP.xlsx", 
          overwrite = TRUE)

file.copy("./tables/SWTP_Tables.xlsx", 
          "../docs/SWTP_Tables.xlsx", 
          overwrite = TRUE)
